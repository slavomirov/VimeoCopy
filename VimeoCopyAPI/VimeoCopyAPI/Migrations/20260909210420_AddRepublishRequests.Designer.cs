...
namespace VimeoCopyAPI.Migrations
{
    ...
    [Migration("20260909210420_AddRepublishRequests")]
    partial class AddRepublishRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VimeoCopyAPI.Models.AdminAuditLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("VimeoCopyAPI.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<long?>("BonusBandwidth")
                        .HasColumnType("bigint");

                    b.Property<long?>("BonusMemory")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("VimeoCopyAPI.Models.DownloadRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MediaId", "RequesterUserId", "Status");

                    b.HasIndex("OwnerUserId", "Status", "CreatedAt");

                    b.HasIndex("OwnerUserId", "RequesterUserId", "Kind", "Status");
            ...
            modelBuilder.Entity("VimeoCopyAPI.Models.RepublishRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("MediaId", "Status");

                    b.HasIndex("Status", "CreatedAt");

                    b.ToTable("RepublishRequests");
                });
            ...
            modelBuilder.Entity("VimeoCopyApi.Models.Media", b =>
                {
                    ...
                    b.Property<string>("GifContentType")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<long?>("GifSize")
                        .HasColumnType("bigint");
                    ...
                    b.Property<bool>("StaffHidden")
                        .HasColumnType("bit");

                    b.Property<string>("StaffHiddenReason")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.HasIndex("IsPublic", "ShowOnMediaPage", "IsProfileAsset", "UploadedAt")
